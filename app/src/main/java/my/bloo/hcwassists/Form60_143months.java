...
public class Form60_143months extends AppCompatActivity {
    ...
    void calculateSpo2() {
        ...
        spo2_input = findViewById(R.id.text_input_spo2_04);
    ...
    void calculateBloodPressure() {
        bloodpressue_input = findViewById(R.id.text_input_bp_04);
    ...
    void calculateHeartRate() {
        heartRate_input = findViewById(R.id.text_input_hr_04);
    ...
    void calculateRespiratoryRate() {
        respi_input = findViewById(R.id.text_input_resp_04);
    ...
    void calculateTemperature() {
        tempRange_radioGroup = (RadioGroup) findViewById(R.id.radioGroupTempRange_04);
        checkedRadioGroupTemperature = tempRange_radioGroup.getCheckedRadioButtonId();
        intRb01 = findViewById(R.id.rBtn04_tR_01_Less365).getId();
        intRb02 = findViewById(R.id.rBtn04_tR_02_36_37).getId();
        intRb03 = findViewById(R.id.rBtn04_tR_03_375_379).getId();
        intRb04 = findViewById(R.id.rBtn04_tR_04_38_39).getId();
        intRb05 = findViewById(R.id.rBtn04_tR_05_40_above).getId();
    ...
    void calculateConsciousLevel() {
        consciousLevel_radioGroup = (RadioGroup) findViewById(R.id.radioGroupConscious_04);
        checkedRadioGroupConsciusLevel = consciousLevel_radioGroup.getCheckedRadioButtonId();
        intRb01 = findViewById(R.id.rBtn04_cL_01_alert).getId();
        intRb02 = findViewById(R.id.rBtn04_cL_02_verbal).getId();
        intRb03 = findViewById(R.id.rBtn04_cL_03_pain).getId();
        intRb04 = findViewById(R.id.rBtn04_cL_04_unconscious).getId();
    ...
    void calculateOxygen() {
        oxygenDelivery_radioGroup = (RadioGroup) findViewById(R.id.radioGroupOxygen_04);
        checkedRadioGroupOxygen = oxygenDelivery_radioGroup.getCheckedRadioButtonId();
        intRb01 = findViewById(R.id.rBtn04_oD_01_room).getId();
        intRb02 = findViewById(R.id.rBtn04_oD_02_nasal).getId();
        intRb03 = findViewById(R.id.rBtn04_oD_03_cpap).getId();
        intRb04 = findViewById(R.id.rBtn04_cL_04_nippv).getId();
        intRb05 = findViewById(R.id.rBtn04_cL_05_ventilated).getId();
    ...
    void calculateCapilary() {
        ...
        capilary_radioGroup = (RadioGroup) findViewById(R.id.radioGroupCapilary_04);

        checkedRadioGroupCapilary = capilary_radioGroup.getCheckedRadioButtonId();
        intRb01 = findViewById(R.id.rBtn04_capR_01_less2).getId();
        intRb02 = findViewById(R.id.rBtn04_capR_02_3_4sec).getId();
        intRb03 = findViewById(R.id.rBtn04_capR_03_5sec).getId();
