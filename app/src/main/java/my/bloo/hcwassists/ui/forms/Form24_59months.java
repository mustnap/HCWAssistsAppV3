...
public class Form24_59months extends AppCompatActivity {
    ...
    void calculateSpo2() {
        ...
        spo2_input = findViewById(R.id.text_input_spo2_03);
    ...
    void calculateBloodPressure() {
        bloodpressue_input = findViewById(R.id.text_input_bp_03);
    ...
    void calculateHeartRate() {
        heartRate_input = findViewById(R.id.text_input_hr_03);
    ...
    void calculateRespiratoryRate() {
        respi_input = findViewById(R.id.text_input_resp_03);
    ...
    void calculateTemperature() {
        ...
        intRb02 = findViewById(R.id.rBtn02_tR_03_36_37).getId();
    ...
    void calculateConsciousLevel() {
        ...
        intRb02 = findViewById(R.id.rBtn02_cL_03_verbal).getId();
    ...
    void calculateOxygen() {
        ...
        intRb02 = findViewById(R.id.rBtn02_oD_03_nasal).getId();
    ...
    void calculateCapilary() {
        ...
        intRb02 = findViewById(R.id.rBtn02_capR_03_3_4sec).getId();
